...
namespace AngApp.Repository
{
    ...
    {
        internal static void Initialize(AngAppContext context)
        {
            ...
            context.SaveChanges();
            foreach (Seller objSeller in Sellers)
            {               
                context.Sellers.Add(objSeller);
            }
            context.SaveChanges();
        ...
        {
            new Seller{ SellerId=1,SellerNumber="ABC00000",FName="Harold",LName="Ginger", DateSold=DateTime.Today},
            new Seller{ SellerId=2,SellerNumber="ABC00001",FName="Gerald",LName="Butler", DateSold=DateTime.Today.AddDays(-1)},
            new Seller{ SellerId=3,SellerNumber="ABC00002",FName="Jamie",LName="King", DateSold=DateTime.Today.AddDays(-2)},
            new Seller{ SellerId=4,SellerNumber="ABC00003",FName="Fox",LName="Pro", DateSold=DateTime.Today.AddDays(-3)},
            new Seller{ SellerId=5,SellerNumber="ABC00004",FName="Jamie",LName="Fox", DateSold=DateTime.Today.AddDays(-4)},
            new Seller{ SellerId=6,SellerNumber="ABC00005",FName="Catherine",LName="Zones", DateSold=DateTime.Today.AddDays(-5)},
        };
